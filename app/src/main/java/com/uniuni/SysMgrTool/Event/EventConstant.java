...
public class EventConstant {
    ...
    public final static String EVENT_LOGIN        = "after_user_login";
    public final static String EVENT_TO_LOGIN      = "to_login";
    public final static String EVENT_UPLOAD_FAILURE = "upload_failure";
