...
public class ScanBatchReportData {
    ...
    public int getTotal_return_parcels() {
        return total_return_parcels;
    }
    public void setTotal_return_parcels(int total_return_parcels) {
        this.total_return_parcels = total_return_parcels;
    }
